...
def visit_create(driver):
    try:
        ...
        driver.find_element(By.XPATH, "/html/body/main/div/table/tbody/tr[1]/td[7]/a").click()
        ...
        driver.find_element(By.XPATH, '/html/body/main/div/div/div/div/form/div[1]/div[4]/select/option[1]').click()
